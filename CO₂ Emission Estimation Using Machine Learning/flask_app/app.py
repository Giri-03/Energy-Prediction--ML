...
# CONFIG - Use relative path that works on any system
...
FEATURES_PATH = MODELS_DIR / "feature_list.pkl"   # optional
PIPELINE_PATH = MODELS_DIR / "co2_pipeline.pkl"   # optional
DATA_CSV = DATA_DIR / "processed_co2_data.csv"
